...
class AtariEnv(Env):
    ...
    def __init__(
        ...
        self._action_set = self.ale.getMinimalActionSet() if not full_action_set else self.ale.getLegalActionSet()
    ...
    def _get_screen(self, frame=1):
        ...
        # frame shape == (210,160,1) if self.grayscale else (210,160,3)
        if self.grayscale:
