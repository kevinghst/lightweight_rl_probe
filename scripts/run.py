...
def main(args: DictConfig):
    ...
    if args.runner.n_steps > 0 and args.do_online:
        ...
        _, _, _, _ = train(config, offline=False, state_dict=model_state_dict, optim_state_dict=optim_state_dict)
...
def train(
    ...
    *,
    ...
    runner = runner_type(
        algo=algo, agent=agent, sampler=sampler, save_fn=save_fn, start_itr=start_itr, **config["runner"]
    )
